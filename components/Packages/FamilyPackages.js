...
const FamilyPackages = () => {
  ...
  useEffect(() => {
    ...
    const packagesRef = ref(db, 'packages/Family Packages');
          ...
          <div className="col-xl-4 col-md-6" key={pkg.id}>
            ...
            >
              ...
              <div className="content">
                ...
                <h5>
                  <Link href={`/tour-details/${pkg.id}?category=Family Packages`}>
                    {pkg.place}
                  </Link>
                </h5>
                ...
                <div className="destination-footer">
                  ...
                  <Link
                    href={`/tour-details/${pkg.id}?category=Family Packages`}
